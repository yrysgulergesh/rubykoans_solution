...
class AboutArrays < Neo::Koan
  def test_creating_arrays
    empty_array = []
    assert_equal Array, empty_array.class  # Измените "FILL ME IN" на Array
  ...
  def test_slicing_arrays
    ...
    assert_equal ["peanut"], array.slice(0,1)
    assert_equal ["peanut", "butter"], array.slice(0,2)
    assert_equal ["and", "jelly"], array.slice(2,2)
    assert_equal ["and", "jelly"], array.slice(2,20)
    assert_equal [], array.slice(4,0)
    assert_equal [], array.slice(4,100)
    assert_equal nil, array.slice(5,0)
  end

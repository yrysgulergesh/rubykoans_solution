...
It was the worst of times.
    ...
    assert_equal 54, long_string.length  # Количество символов включая переводы строк
    assert_equal 3, long_string.lines.count
    assert_equal "\n", long_string[0,1]
  end
...
It was the worst of times.
EOS
    assert_equal 53, long_string.length  # Количество символов, без начального перевода строки
    assert_equal 2, long_string.lines.count
    assert_equal "I", long_string[0,1]
  end

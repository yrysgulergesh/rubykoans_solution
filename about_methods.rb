...
class AboutMethods < Neo::Koan
  ...
  def test_sometimes_missing_parentheses_are_ambiguous
    ...
    assert_equal 5, my_global_method(2, 3) # ENABLE CHECK
    # You should really write the previous line as:
    # assert_equal(5, my_global_method(2, 3))
  end
  ...
  def another_method_in_the_same_class
    my_method_in_the_same_class(3, 4)
  end

  def test_calling_private_methods
    assert_equal 12, another_method_in_the_same_class
  end

  private :another_method_in_the_same_class
end

...
class AboutObjects < Neo::Koan
  ...
  def test_every_object_has_an_id
    obj = Object.new
    assert_equal true, obj.object_id.is_a?(Integer)
  end
  ...
  def test_small_integers_have_fixed_ids
    assert_equal true, 1.object_id == 1.object_id
    assert_equal true, 2.object_id == 2.object_id
    assert_equal true, 100.object_id == 100.object_id
  end
